...
namespace DoubleMMPrjc
{
    ...
    ITriggerListener, IArrowsListener
    {
        ...
        public override void Start()
        {
            ...
            flyAttackCountdown = TimerManager.StartCountdown( FLY_ATTACK_TIME, false, this );
        ...
        public void SimpleAtack()
        {
            ...
            if (TimerManager.HasEnded( simpleAttackCountdown )) {
                ...
                weapon.SetNextAttackInfo(
                    new Attack( 1, new Vector2( lookDirection, 0 ), SIMPLE_ATTACK_MOVE, 0.17f ),
                    SIMPLE_ATTACK_TIME );
        ...
        public void FlyAttack()
        {
            if (TimerManager.HasEnded( flyAttackCountdown )) {
                ...
                weapon.SetNextAttackInfo(
                    new Attack( damage.current, new Vector2( 0, 1 ), 15, FLY_ATTACK_TIME * 1.2f ),
                    FLY_ATTACK_TIME );
        ...
        public void BackwardAttack()
        {
            if (TimerManager.HasEnded( backwardAttackCountdown )) {
                ...
                transform.rotation = Quaternion.LookRotation( new Vector3( 0, 0, lookDirection ), transform.up );
                weapon.SetNextAttackInfo(
                    new Attack( damage.current * 2, new Vector3( lookDirection, 0 ), SIMPLE_ATTACK_MOVE * 2 ),
